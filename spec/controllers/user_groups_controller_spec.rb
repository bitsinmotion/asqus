  ...
  describe "POST create" do
    ...
    describe "with invalid params" do
      it "assigns a newly created but unsaved user_group as @user_group" do
        ...
        post :create, {:user_group => { "user_id" => "invalid value" }}, valid_session
        assigns(:user_group).should be_a_new(UserGroup)
      end
  ...
  describe "PUT update" do
    describe "with valid params" do
      it "updates the requested user_group" do
        ...
        UserGroup.any_instance.should_receive(:update_attributes).with({ "user_id" => "1" })
        put :update, {:id => user_group.to_param, :user_group => { "user_id" => "1" }}, valid_session
      end
    ...
    describe "with invalid params" do
      it "assigns the user_group as @user_group" do
        ...
        # Trigger the behavior that occurs when invalid params are submitted
        UserGroup.any_instance.stub(:save).and_return(false)
        put :update, {:id => user_group.to_param, :user_group => { "user_id" => "invalid value" }}, valid_session
        assigns(:user_group).should eq(user_group)
      end
