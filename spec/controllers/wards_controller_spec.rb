  ...
  describe "POST create" do
    ...
    describe "with invalid params" do
      it "assigns a newly created but unsaved ward as @ward" do
        ...
        post :create, {:ward => { "municipality_id" => "invalid value" }}, valid_session
        assigns(:ward).should be_a_new(Ward)
      end
  ...
  describe "PUT update" do
    describe "with valid params" do
      it "updates the requested ward" do
        ...
        Ward.any_instance.should_receive(:update_attributes).with({ "municipality_id" => "1" })
        put :update, {:id => ward.to_param, :ward => { "municipality_id" => "1" }}, valid_session
      end
    ...
    describe "with invalid params" do
      it "assigns the ward as @ward" do
        ...
        # Trigger the behavior that occurs when invalid params are submitted
        Ward.any_instance.stub(:save).and_return(false)
        put :update, {:id => ward.to_param, :ward => { "municipality_id" => "invalid value" }}, valid_session
        assigns(:ward).should eq(ward)
      end
